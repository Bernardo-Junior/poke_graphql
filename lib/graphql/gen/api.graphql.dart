...
class FetchPokemons$Query$Pokemons extends JsonSerializable
    with EquatableMixin {
  FetchPokemons$Query$Pokemons();

  factory FetchPokemons$Query$Pokemons.fromJson(Map<String, dynamic> json) =>
      _$FetchPokemons$Query$PokemonsFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() => _$FetchPokemons$Query$PokemonsToJson(this);
}
...
class FetchPokemons$Query extends JsonSerializable with EquatableMixin {
  ...
  List<FetchPokemons$Query$Pokemons?>? pokemons;
